      ...
      <div
        className={cn(
          ...
          variant === "floating"
            ...
            : variant === "inset"
              ? "py-3 pl-3 pr-1 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)] md:top-3 md:bottom-3 md:h-auto"
